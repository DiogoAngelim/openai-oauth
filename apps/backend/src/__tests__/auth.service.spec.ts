...
describe('AuthService', () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(jwtService, 'verifyAsync').mockImplementation(async <T extends object>(): Promise<T> => {
  ...
  describe('generateTokens', () => {
    it('should generate and return tokens', async () => {
      ...
      const user = { id: 'user4', email: 'user4@example.com' } as { id: string, email: string }
